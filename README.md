...
wiki [migrate handler page](https://github.com/juank-pa/App-DB-Migrate/wiki/The-Migrate-Handler).
...
## References
* The App-DB-Migrate [wiki](https://github.com/juank-pa/App-DB-Migrate/wiki).
