...
subtest 'Timestamp delegates methods to column' => sub {
    ...
    my $ts = App::DB::Migrate::Column::Timestamp->new('my_table', { name => 'custom_name' });
...
subtest 'is SQLizable' => sub {
    my $ts = App::DB::Migrate::Column::Timestamp->new('table');
    isa_ok($ts, "App::DB::Migrate::SQLizable");
};
