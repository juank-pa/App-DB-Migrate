...
subtest 'remove_column removes a column from the column list' => sub {
    my $idx = App::DB::Migrate::SQLite::Index->new('table_name', ['col1', 'col2']);
